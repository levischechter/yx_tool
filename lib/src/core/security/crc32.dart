 ...
 * questions.
 */
class Crc32 extends Converter<List<int>, int> {
  const Crc32._();
  ...
  static int byte2crc32sum({required Uint8List data, int seed = 0, int? size}) {
    var crc = seed;
    size ??= data.length;
  ...
  static int byte2crc32(Uint8List data) {
  ...
  static Uint8List int2quad(int input) {
    var output = Uint8List(4);
    for (var i = 0; i < 4; i++) {
